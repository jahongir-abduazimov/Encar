      ...
      <Container>
        <div className="sm:hidden flex gap-5 border-b border-gray-400 overflow-x-auto justify-between">
          <button
            ...
            className={`flex flex-col items-center py-2 ${
              section === "balance" || !section ? "text-primary" : "text-black"
            }`}
          >
          ...
          <button
            ...
            className={`flex flex-col items-center py-2 ${
              section === "subscribes" ? "text-primary" : "text-black"
            }`}
          >
          ...
          <button
            ...
            className={`flex flex-col items-center py-2 ${
              section === "reports" ? "text-primary" : "text-black"
            }`}
          >
          ...
          <button
            ...
            className={`flex flex-col items-center py-2 ${
              section === "favorites" ? "text-primary" : "text-black"
            }`}
          >
            <FaHeart size={24} />
          ...
          <button
            ...
            className={`flex flex-col items-center py-2 ${
              section === "compare" ? "text-primary" : "text-black"
            }`}
          >
          ...
          <button
            ...
            className={`flex flex-col items-center py-2 ${
              section === "user_settings" ? "text-primary" : "text-black"
            }`}
          >
        ...
        <div className="flex items-start gap-10">
          <div className="hidden md:min-w-[230px] border border-black/40 sm:flex flex-col">
            <button
              onClick={() => router.push("/cabinet?section=balance")}
              className={`flex items-center gap-3 py-2 px-3 cursor-pointer border-b border-black/40 hover:text-white ${
                section === "balance" || !section ? "bg-primary text-white" : "hover:bg-black/40"
              }`}
            >
            ...
            <button
              onClick={() => router.push("/cabinet?section=subscribes")}
              className={`flex items-center gap-3 py-2 px-3 cursor-pointer border-b border-black/40 hover:text-white ${
                section === "subscribes" ? "bg-primary text-white" : "hover:bg-black/40"
              }`}
            >
            ...
            <button
              onClick={() => router.push("/cabinet?section=reports")}
              className={`flex items-center gap-3 py-2 px-3 cursor-pointer border-b border-black/40 hover:text-white ${
                section === "reports" ? "bg-primary text-white" : "hover:bg-black/40"
              }`}
            >
            ...
            <button
              onClick={() => router.push("/cabinet?section=favorites")}
              className={`flex items-center gap-3 py-2 px-3 cursor-pointer border-b border-black/40 hover:text-white ${
                section === "favorites" ? "bg-primary text-white" : "hover:bg-black/40"
              }`}
            >
              <FaHeart size={20} />
            ...
            <button
              onClick={() => router.push("/cabinet?section=compare")}
              className={`flex items-center gap-3 py-2 px-3 cursor-pointer border-b border-black/40 hover:text-white ${
                section === "compare" ? "bg-primary text-white" : "hover:bg-black/40"
              }`}
            >
            ...
            <button
              onClick={() => router.push("/cabinet?section=user_settings")}
              className={`flex items-center gap-3 py-2 px-3 cursor-pointer hover:text-white ${
                section === "user_settings" ? "bg-primary text-white" : "hover:bg-black/40"
              }`}
            >
